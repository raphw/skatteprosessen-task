...
public class TaskInfo extends Task {
    ...
    private final OffsetDateTime created, completed, scheduled;

    public TaskInfo(
        long sequence, String identifier,
        TaskState state, TaskState descent, String owner, String reference,
        OffsetDateTime created, OffsetDateTime completed, OffsetDateTime scheduled,
    ...
    public Optional<OffsetDateTime> getScheduled() {
